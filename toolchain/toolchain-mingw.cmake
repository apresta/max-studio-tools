...
if(NOT DEFINED LLVM_MINGW_PREFIX)
  # CMAKE_CURRENT_LIST_DIR is the toolchain/ directory; .. is the repo root.
  # CMAKE_SOURCE_DIR must NOT be used here - it resolves to a CMake scratch
  # directory during compiler detection try_compile passes.
  get_filename_component(LLVM_MINGW_PREFIX
      "${CMAKE_CURRENT_LIST_DIR}/../deps/llvm-mingw" ABSOLUTE)
endif()
