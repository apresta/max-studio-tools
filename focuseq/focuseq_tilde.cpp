...
class focuseq_tilde : public object<focuseq_tilde>,
 ...
 public:
  ...
  attribute<number> hpf{
      ...
      range{16.0, 350.0},
      setter{MIN_FUNCTION{params_.hpf_freq =
                              clamp(static_cast<double>(args[0]), 16.0, 350.0);
  return args;
}
}
}
...
attribute<int> hpfon{
    ...
    setter{MIN_FUNCTION{params_.hpf_enabled = (static_cast<int>(args[0]) != 0);
return args;
}
}
}
...
attribute<number> lpf{
    ...
    setter{MIN_FUNCTION{
        params_.lpf_freq = clamp(static_cast<double>(args[0]), 1000.0, 20000.0);
return args;
}
}
}
...
attribute<int> lpfon{
    ...
    setter{MIN_FUNCTION{params_.lpf_enabled = (static_cast<int>(args[0]) != 0);
return args;
}
}
}
...
attribute<number> lowfreq{
    ...
    setter{MIN_FUNCTION{params_.low_freq =
                            clamp(static_cast<double>(args[0]), 30.0, 450.0);
return args;
}
}
}
...
attribute<number> lowgain{
    ...
    setter{MIN_FUNCTION{params_.low_gain =
...
attribute<int> lowtype{
    ...
    description{"0 = low shelf (default), 1 = bell (peaking EQ)."}, range{0, 1},
    setter{MIN_FUNCTION{params_.low_shape = (static_cast<int>(args[0]) != 0)
...
attribute<number> lmfreq{
    ...
    setter{MIN_FUNCTION{params_.lomid_freq =
...
attribute<number> lmgain{
    ...
    description{"Boost or cut in dB."}, range{-16.0, 16.0},
    setter{MIN_FUNCTION{params_.lomid_gain =
                            clamp(static_cast<double>(args[0]), -16.0, 16.0);
return args;
}
}
...
attribute<number> lmq{
    ...
    range{0.0, 1.0},
    setter{MIN_FUNCTION{params_.lomid_q =
...
attribute<number> hmfreq{
    ...
    setter{MIN_FUNCTION{params_.himid_freq =
...
attribute<number> hmgain{
    ...
    description{"Boost or cut in dB."}, range{-16.0, 16.0},
    setter{MIN_FUNCTION{params_.himid_gain =
                            clamp(static_cast<double>(args[0]), -16.0, 16.0);
return args;
}
}
...
attribute<number> hmq{
    ...
    description{"Quality factor. Proportional-Q is applied on top."},
    range{0.0, 1.0},
    setter{MIN_FUNCTION{params_.himid_q =
                            clamp(static_cast<double>(args[0]), 0.0, 1.0);
return args;
}
}
...
attribute<number> highfreq{
    ...
    description{"Shelf knee or bell center frequency."}, range{1500.0, 16000.0},
    setter{MIN_FUNCTION{params_.high_freq = clamp(static_cast<double>(args[0]),
                                                  1500.0, 16000.0);
return args;
}
}
...
attribute<number> highgain{
    ...
    description{"Boost or cut in dB."}, range{-16.0, 16.0},
    setter{MIN_FUNCTION{params_.high_gain =
                            clamp(static_cast<double>(args[0]), -16.0, 16.0);
return args;
}
}
...
attribute<int> hightype{
    ...
    range{0, 1},
    setter{MIN_FUNCTION{params_.high_shape = (static_cast<int>(args[0]) != 0)
                                                 ? FocusEqDsp::BandShape::Bell
                                                 : FocusEqDsp::BandShape::Shelf;
return args;
}
...
attribute<int> sat_enable{
    ...
    setter{MIN_FUNCTION{params_.sat_enable = (static_cast<int>(args[0]) != 0);
return args;
}
}
}
...
attribute<number> gain{
    ...
    range{0.0, 1.0},
    setter{MIN_FUNCTION{params_.sat_gain =
                            clamp(static_cast<double>(args[0]), 0.0, 1.0);
return args;
}
}
