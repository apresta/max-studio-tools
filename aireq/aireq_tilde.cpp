...
class aireq_tilde : public object<aireq_tilde>,
 ...
 public:
  ...
  attribute<number> gain10{
      ...
      setter{MIN_FUNCTION{
        params_.gains[AirEqDsp::kBand10] =
  ...
  attribute<number> gain40{
      ...
      setter{MIN_FUNCTION{
        params_.gains[AirEqDsp::kBand40] =
            clamp(static_cast<double>(args[0]), -10.0, 10.0);
        return args;
      }}};
  ...
  attribute<number> gain160{
      ...
      setter{MIN_FUNCTION{
        params_.gains[AirEqDsp::kBand160] =
            clamp(static_cast<double>(args[0]), -10.0, 10.0);
        return args;
      }}};
  ...
  attribute<number> gain640{
      ...
      setter{MIN_FUNCTION{
        params_.gains[AirEqDsp::kBand640] =
            clamp(static_cast<double>(args[0]), -10.0, 10.0);
        return args;
      }}};
  ...
  attribute<number> gain2k5{
      ...
      setter{MIN_FUNCTION{
        params_.gains[AirEqDsp::kShelf2k5] =
            clamp(static_cast<double>(args[0]), -10.0, 10.0);
        return args;
      }}};
  ...
  attribute<number> gainhi{
      ...
      setter{MIN_FUNCTION{
        params_.gains[AirEqDsp::kShelfHi] =
  ...
  attribute<int> keepgain{
      ...
      range{0, 1},
      setter{MIN_FUNCTION{
        params_.keep_gain = (static_cast<int>(args[0]) != 0);
        return args;
      }}};
  ...
  attribute<int> oversample{
      ...
      setter{MIN_FUNCTION{
        const int v =
            clamp(static_cast<int>(args[0]), 0, oversample::kMaxOversampleIndex);
